...
public class CusDevPlanController extends BaseController {
    ...
    public ResultInfo updateCusDevPlan(CusDevPlan cusDevPlan){
        ...
        return success("开发计划项更新成功");
    }

    @RequestMapping("delete")
    @ResponseBody
    public ResultInfo deleteCusDevPlan(Integer sid){
        cusDevPlanService.deleteCusDevPlan(sid);
        return success("开发计划项删除成功");
    }
